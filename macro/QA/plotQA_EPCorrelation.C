...
void plotQA_EPCorrelation(int order = 1, int cent10 = 5)
{
  ...
  string FigName = Form("/direct/phenix+u/xusun/WorkSpace/PHENIX/figures/QA_BBC/EventPlane/c_EPCorrelation_%s.eps",mOrder[order].c_str());
