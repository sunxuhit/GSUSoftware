...
void plotQA_EPCorrelation(int order = 1, int cent10 = 1)
{
  const string mOrder[3] = {"1st","2nd","3rd"};
  const string mCentrality = Form("%1.1f-%1.1f%%",vecMesonFlow::mCentStart10[cent10],vecMesonFlow::mCentStop10[cent10]);
  ...
  string HistName_Raw = Form("h_mEPRaw_Correlation_%s_Centrality_%d",mOrder[order].c_str(),cent10);
  ...
  string HistName_ReCenter = Form("h_mEPReCenter_Correlation_%s_Centrality_%d",mOrder[order].c_str(),cent10);
  ...
  string HistName_Shift = Form("h_mEPShift_Correlation_%s_Centrality_%d",mOrder[order].c_str(),cent10);
  ...
  // string FigName = Form("/direct/phenix+u/xusun/WorkSpace/PHENIX/figures/QA_BBC/EventPlane/c_EPCorrelation_%s_%d.eps",mOrder[order].c_str(),cent10);
  string FigName = Form("/direct/phenix+u/xusun/WorkSpace/PHENIX/figures/QA_BBC/EventPlane/c_EPCorrelation_%s_%d_woPhiWeight.eps",mOrder[order].c_str(),cent10);
