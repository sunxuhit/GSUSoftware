...
class RecoEPProManager : public TObject
{
  public:
    ...
    void fillPro_BbcSouthReCenter(TVector2 QVecRaw_BbcSouth, float QWeight_BbcSouth, int order, int vtx4, int runIndex, int cent20);
    void fillPro_BbcNorthReCenter(TVector2 QVecRaw_BbcNorth, float QWeight_BbcNorth, int order, int vtx4, int runIndex, int cent20);
    void writePro_BbcReCenter();
    //===============BBC Event Plane ReCenter=========================

    //===============BBC Event Plane Shift=========================
    void initPro_BbcShift();
    void fillPro_BbcSouthShift(float PsiReCenter_BbcSouth, int order, int vtx4, int runIndex, int cent20);
    void fillPro_BbcNorthShift(float PsiReCenter_BbcNorth, int order, int vtx4, int runIndex, int cent20);
  ...
  private:
    //===============BBC Event Plane ReCenter=========================
    // ReCenter Correction | x-axis is runIndex, y-axis is centrality (every 5%)
    ...
    //===============BBC Event Plane Shift=========================
    // Shift Correction | x-axis is runIndex, y-axis is centrality (every 5%)
