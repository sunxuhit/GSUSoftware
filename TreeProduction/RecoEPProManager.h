...
class RecoEPProManager : public TObject
{
  public:
    ...
    void fillPro_BbcResolution(float Psi_BbcSouth, float Psi_BbcNorth, int order, int runIndex, int cent20);
    void writePro_BbcResolution();
    //===============BBC Event Plane Resolution=========================

    //===============FVTX Event Plane Resolution=========================
    void initPro_FvtxResolution();
    void fillPro_FvtxResolution(float Psi_FvtxSouth, float Psi_FvtxNorth, int order, int runIndex, int cent20);
