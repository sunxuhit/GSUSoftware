...
my @HubertAgelRefrIndex = ( 1.02435, 1.0244,  1.02445, 1.0245,  1.02455,
...
#modified by Ping 04-04-2016
#my @AcAbsLength = (  "00.556*cm", "00.556*cm", "00.556*cm", "00.556*cm",
#		     "00.556*cm", "00.556*cm", "00.556*cm", "00.556*cm",
#		     "00.556*cm", "00.556*cm", "00.556*cm", "00.556*cm",
#		     "00.556*cm", "00.556*cm", "00.556*cm", "00.556*cm",
#		     "00.556*cm", "00.632*cm", "00.632*cm", "00.619*cm",
#		     "00.455*cm", "00.667*cm", "00.037*cm", "00.333*cm",
...
#100 grooves Fresnel lens !!! WRONG !!!
#my @AcAbsLength = (  "3.25*cm", "3.25cm", "3.25*cm", "3.25*cm",
#		     "3.25*cm", "3.25cm", "3.25*cm", "3.25*cm",
#		     "3.25*cm", "3.25cm", "3.25*cm", "3.25*cm",
#		     "3.25*cm", "3.25cm", "3.25*cm", "3.25*cm",
#		     "3.25*cm", "3.25cm", "3.25*cm", "3.25*cm",
#		     "3.25*cm", "00.667*cm", "00.037*cm", "00.333*cm",
 #                    "00.001*cm", "00.001*cm", "00.001*cm", "00.001*cm",
#		     "00.001*cm", "00.001*cm", "00.001*cm", "00.001*cm" );

#200 grooves Fresnel lens
my @AcAbsLength = (  "4*cm", "4*cm", "4*cm", "4*cm",
		     "4*cm", "4*cm", "4*cm", "4*cm",
		     "4*cm", "4*cm", "4*cm", "4*cm",
		     "4*cm", "4*cm", "4*cm", "4*cm",
		     "4*cm", "4*cm", "4*cm", "4*cm",
		     "4*cm", "00.667*cm", "00.037*cm", "00.333*cm",
                    "00.001*cm", "00.001*cm", "00.001*cm", "00.001*cm",
		     "00.001*cm", "00.001*cm", "00.001*cm", "00.001*cm" );

#250 grooves Fresnel lens !!! WRONG !!!
#my @AcAbsLength = (  "2.06*cm", "2.06*cm", "2.06*cm", "2.06*cm",
#		     "2.06*cm", "2.06*cm", "2.06*cm", "2.06*cm",
#		     "2.06*cm", "2.06*cm", "2.06*cm", "2.06*cm",
#		     "2.06*cm", "2.06*cm", "2.06*cm", "2.06*cm",
#		     "2.06*cm", "2.06*cm", "2.06*cm", "2.06*cm",
#		     "2.06*cm", "00.667*cm", "00.037*cm", "00.333*cm",                                                         
#                   "00.001*cm", "00.001*cm", "00.001*cm", "00.001*cm",                                                       
#                  "00.001*cm", "00.001*cm", "00.001*cm", "00.001*cm" );
#=======================================================================================#
...
# the first argument to this function become the variation
	...
	print"Hubert's Agel\n";
        ...
        $mat{"indexOfRefraction"} = arrayToString(@HubertAgelRefrIndex);
