...
int plotQA_PMT_ringFinder()
{
  ...
  if( is_sim )
  {
    File_InPut = TFile::Open("/Users/xusun/WorkSpace/EICPID/Data/BeamTest_mRICH/OutPut/Simulation/PMT/GEMC_Calibration.root");
    h_mPhotonDist = (TH2D*)File_InPut->Get("h_mPhotonDist_SingleEvent")->Clone();
  }

  if( !is_sim )
  {
    File_InPut = TFile::Open("/Users/xusun/WorkSpace/EICPID/Data/BeamTest_mRICH/OutPut/BeamTest/PMT/BeamTest_Calibration.root");
  ...
  string ringFinder;
  if( is_sim ) ringFinder = "/Users/xusun/WorkSpace/EICPID/figures/BeamTest_mRICH/QA/PMT/c_ringFinder_sim.eps";
  if( !is_sim ) ringFinder = "/Users/xusun/WorkSpace/EICPID/figures/BeamTest_mRICH/QA/PMT/c_ringFinder_data.eps";
