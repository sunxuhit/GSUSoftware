...
void comQA_MPPC_NumOfPhotons()
{
  string inputSim = "/Users/xusun/WorkSpace/EICPID/Data/BeamTest_mRICH/OutPut/Simulation/MPPC/GEMC_Calibration.root";
  TFile *File_Sim = TFile::Open(inputSim.c_str());
  TH1D *h_NumOfPhotons_Sim = (TH1D*)File_Sim->Get("h_mNumOfPhotons")->Clone();
  TH2D *h_NumOfCherenkovPhotons_Sim = (TH2D*)File_Sim->Get("h_mNumOfCherenkovPhotons")->Clone();
  TH1D *h_NumOnRing_Sim = (TH1D*)h_NumOfCherenkovPhotons_Sim->ProjectionY()->Clone("h_NumOnRing_Sim");
  ...
  c_NumOfPhotons->SaveAs("/Users/xusun/WorkSpace/EICPID/figures/BeamTest_mRICH/QA/MPPC/Calibration/c_NumOfPhotons.eps");
  ...
  c_NumOnRing->SaveAs("/Users/xusun/WorkSpace/EICPID/figures/BeamTest_mRICH/QA/MPPC/Calibration/c_NumOnRing.eps");
}
