...
int plotQA_MPPC_ringFinder()
{
  ...
  if( is_sim )
  {
    File_InPut = TFile::Open("/Users/xusun/WorkSpace/EICPID/Data/BeamTest_mRICH/OutPut/Simulation/MPPC/GEMC_Calibration.root");
    h_mPhotonDist = (TH2D*)File_InPut->Get("h_mPhotonDist_SingleEvent")->Clone();
  }

  if( !is_sim )
  {
    File_InPut = TFile::Open("/Users/xusun/WorkSpace/EICPID/Data/BeamTest_mRICH/OutPut/BeamTest/MPPC/BeamTest_Calibration.root");
    /* h_mPhotonDist = (TH2D*)File_InPut->Get("h_mRingImage_DisPlay")->Clone(); */
    h_mPhotonDist = (TH2D*)File_InPut->Get("h_mRingFinder_SingleEvent")->Clone();
  }
  ...
  string ringFinder;
  if( is_sim ) ringFinder = "/Users/xusun/WorkSpace/EICPID/figures/BeamTest_mRICH/QA/MPPC/c_ringFinder_sim.eps";
  if( !is_sim ) ringFinder = "/Users/xusun/WorkSpace/EICPID/figures/BeamTest_mRICH/QA/MPPC/c_ringFinder_data.eps";
